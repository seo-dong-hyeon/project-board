...
// 통합 테스트 -> repository까지 실행 -> DB 접근, Hibernate query까지
@Transactional // 각 테스트마다 롤백
//@WebMvcTest // slice test -> controller 외의 Bean 들을 로드하지 않음 -> Data Rest Autoconfiguration을 읽지 않음
@AutoConfigureMockMvc // MockMvc 존재를 알도록
